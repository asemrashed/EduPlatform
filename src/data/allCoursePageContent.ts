...
export type CatalogCategoryId = "all" | "ssc" | "hsc" | "admission" | "academic";

export const CATALOG_SIDEBAR = [
  { id: "all" as const, label: "All", count: 48 },
  { id: "ssc" as const, label: "SSC", count: 12 },
  { id: "hsc" as const, label: "HSC", count: 10 },
  { id: "admission" as const, label: "Admission", count: 15 },
  { id: "academic" as const, label: "Academic", count: 11 },
] as const;
