...
const Header = () => {
  ...
  return (
    <header className="relative bg-linear-to-r from-white via-blue-50/30 to-purple-50/30 border-b border-gray-200/50 px-2 sm:px-4 lg:px-6 py-2 sm:py-4 backdrop-blur-sm">

      <div className="relative z-10 flex items-center justify-between">
        <div className="flex items-center gap-2 sm:gap-4">
          <SidebarTrigger className="hover:bg-linear-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-200" />
        ...
        <div className="flex items-center gap-2 sm:gap-4 lg:gap-6">
          {isStudentRoute && latestQuizMark && (
            <div className="flex items-center gap-2 px-2 lg:px-3 py-1 lg:py-2 rounded-lg bg-linear-to-r from-indigo-50 to-blue-50 border border-indigo-200">
          ...
          <div className="hidden sm:flex items-center gap-2 lg:gap-3 px-2 lg:px-4 py-1 lg:py-2 rounded-xl bg-linear-to-r from-gray-50/80 to-blue-50/50 border border-gray-200/50 backdrop-blur-sm">
          ...
          <div className="hidden sm:flex items-center gap-1 lg:gap-2 px-2 lg:px-3 py-1 lg:py-2 rounded-lg bg-linear-to-r from-purple-50/80 to-indigo-50/50 border border-purple-200/50">
          ...
          {/* Notification Button */}
          <button className="relative p-2 lg:p-3 text-gray-600 hover:text-blue-600 hover:bg-linear-to-r hover:from-blue-50 hover:to-purple-50 rounded-xl transition-all duration-200 group">
            <Bell size={16} className="sm:w-5 sm:h-5" />
            <div className="absolute -top-0.5 -right-0.5 lg:-top-1 lg:-right-1 w-2 h-2 lg:w-3 lg:h-3 bg-linear-to-r from-red-400 to-pink-500 rounded-full animate-pulse"></div>
            <div className="absolute inset-0 bg-linear-to-r from-transparent via-blue-100/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></div>
          </button>
          
          {/* User Button */}
          <button className="relative p-2 lg:p-3 text-gray-600 hover:text-purple-600 hover:bg-linear-to-r hover:from-purple-50 hover:to-indigo-50 rounded-xl transition-all duration-200 group">
            <User size={16} className="sm:w-5 sm:h-5" />
            <div className="absolute inset-0 bg-linear-to-r from-transparent via-purple-100/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></div>
          </button>
        </div>
      </div>
    </header>
