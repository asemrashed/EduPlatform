      ...
      <div className="pointer-events-none absolute inset-0 opacity-10">
        <div className="absolute left-0 top-0 h-full w-full">
          <div className="absolute right-20 top-20 flex h-8 w-8 items-center justify-center">
            <div className="absolute h-0.5 w-6" style={{ backgroundColor: "#EC4899" }} />
            <div className="absolute h-6 w-0.5" style={{ backgroundColor: "#EC4899" }} />
          </div>
          <div className="absolute left-16 top-32 flex h-8 w-8 items-center justify-center">
            <div className="absolute h-0.5 w-6" style={{ backgroundColor: "#A855F7" }} />
            <div
          ...
          <div className="absolute right-32 top-48 flex h-8 w-8 items-center justify-center">
            ...
            />
            <div className="absolute left-2 top-2 h-4 w-0.5" style={{ backgroundColor: "#7B2CBF" }} />
            <div className="absolute left-4 top-4 h-0.5 w-2" style={{ backgroundColor: "#7B2CBF" }} />
          </div>
          <div className="absolute bottom-32 left-20 flex h-8 w-8 items-center justify-center">
            <div className="relative h-6 w-6 rounded-full border" style={{ borderColor: "#10B981" }}>
              <div
          ...
          <div className="absolute bottom-20 right-16 flex h-8 w-8 items-center justify-center">
            <div className="relative h-3 w-6 rounded-full border" style={{ borderColor: "#FF6B35" }}>
              <div
