...
const TeacherStats = ({ teachers, loading = false }: TeacherStatsProps) => {
  ...
  const activeTeachers = safeTeachers.filter(teacher => teacher.isActive).length;
  const inactiveTeachers = safeTeachers.filter(teacher => !teacher.isActive).length;
  const totalTeachers = safeTeachers.length;
  const teachersWithAddress = safeTeachers.filter(teacher =>
    teacher.address &&
